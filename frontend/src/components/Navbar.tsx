...
import { LayoutDashboard, FileSearch, Trophy, History, CreditCard, User, LogOut, Hexagon, Moon, Sun, Search } from 'lucide-react';
...
const Navbar: React.FC = () => {
    ...
    const links = [
        ...
        { name: 'Find Skills', path: '/find-skill', icon: Search },
                ...
                <div className="flex justify-between h-16">
                    <div className="flex">
                        <div className="flex-shrink-0 flex items-center gap-2 mr-4">
                            ...
                            <span className="font-bold text-xl text-slate-900 tracking-tight">HireSense</span>
                        </div>
