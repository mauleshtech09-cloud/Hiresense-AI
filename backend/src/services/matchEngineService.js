...
const domainFramework_1 = require("../utils/domainFramework");
const memoryDb_1 = require("../models/memoryDb");
const generateReport = (filename, jobRole, isReassess = false) => {
    const jobDomainFramework = (0, domainFramework_1.determineDomain)(jobRole);
...
//# sourceMappingURL=matchEngineService.js.map