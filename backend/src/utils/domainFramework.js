...
exports.DOMAIN_FRAMEWORKS = void 0;
exports.determineDomain = determineDomain;
exports.DOMAIN_FRAMEWORKS = {
...
function determineDomain(jobRole) {
    const roleLower = jobRole.toLowerCase();
    for (const key of Object.keys(exports.DOMAIN_FRAMEWORKS)) {
        const domain = exports.DOMAIN_FRAMEWORKS[key];
...
//# sourceMappingURL=domainFramework.js.map